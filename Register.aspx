...
<head runat="server">
<title>Balancing Performance, Accuracy, and
Precision for Secure Cloud Transactions</title>
<meta charset="UTF-8">
...
<div id="wrapper">
  <div id="header">
    <div class="logo"><h1 style="width: 943px" class="style1">Balancing Performance, Accuracy, and
Precision for Secure Cloud Transactions</h1></div>
  </div>
  <div class="clear"></div>
            ...
            <asp:Panel ID="Panel2" runat="server" Height="794px">
                <table class="style2">
                    <tr>
                        ...
                        <td class="style33">
                            <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="X-Large" 
                                ForeColor="#009900" Text="User Registration"></asp:Label>
                        </td>
                        <td class="style30">
                            </td>
                        <td class="style30">
                    ...
                    <tr>
                        ...
                        <td class="style10">
                            <asp:TextBox ID="TextBox1" PlaceHolder="Enter the Username" runat="server" BackColor="#FFCCFF" Font-Bold="True" 
                    ...
                    <tr>
                        ...
                        <td class="style7">
                            <asp:TextBox ID="TextBox2" PlaceHolder="Enter the Password" runat="server" BackColor="#FFCCFF" Font-Bold="True" 
                    ...
                    <tr>
                        ...
                        <td class="style108">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#660066" Text="Email_ID"></asp:Label>
                            <br />
                        </td>
                        <td class="style23">
                        ...
                        <td class="style13">
                            <asp:TextBox ID="TextBox3" PlaceHolder="Enter the Email_ID" runat="server" BackColor="#FFCCFF" Font-Bold="True" 
                                Height="24px" Width="215px"></asp:TextBox>
                        </td>
                        <td class="style11">
                    ...
                    <tr>
                        ...
                        <td class="style107">
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#660066" Text="Date Of Birth"></asp:Label>
                            <br />
                        </td>
                        <td class="style22">
                        ...
                        <td class="style7">
                            <asp:TextBox ID="TextBox4" PlaceHolder="Enter the Date Of Birth" runat="server" BackColor="#FFCCFF" Font-Bold="True" 
                                Height="24px" Width="215px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td class="style109">
                            <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#660066" Text="Gender"></asp:Label>
                            <br />
                        </td>
                        <td class="style45">
                    ...
                    <tr>
                        ...
                        <td class="style110">
                            <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#660066" Text="Mobile no."></asp:Label>
                            <br />
                        </td>
                        <td class="style24">
                        ...
                        <td class="style16">
                            <asp:TextBox ID="TextBox5" PlaceHolder="Enter the Mobile No." runat="server" BackColor="#FFCCFF" Font-Bold="True" 
                                Height="24px" Width="215px"></asp:TextBox>
                        </td>
                        <td class="style14">
                    ...
                    <tr>
                        ...
                        <td class="style111">
                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#660066" Text="Address"></asp:Label>
                            <br />
                        </td>
                        <td class="style93">
                        ...
                        <td class="style94">
                            <asp:TextBox ID="TextBox6" PlaceHolder="Enter the Address" runat="server" BackColor="#FFCCFF" Font-Bold="True" 
                    ...
                    <tr>
                        ...
                        <td class="style112">
                            <asp:Label ID="Label17" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#660066" Text="Authorization Policies :"></asp:Label>
                            </td>
                        <td class="style50">
                            </td>
                        <td class="style51">
                    ...
                    <tr>
                        <td class="style85">
                            <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" 
                                PostBackUrl="~/Login.aspx" CausesValidation="False">&lt;&lt;Back to Login</asp:LinkButton>
                        </td>
                        <td class="style114">
                            &nbsp;</td>
                        <td class="style87">
                            &nbsp;</td>
                        <td class="style86">
                            <asp:Button ID="Button1" runat="server" BackColor="#00CC00" BorderStyle="Ridge" 
                                Font-Bold="True" ForeColor="Yellow" Height="32px" onclick="Button1_Click" 
                                Text="Submit" Width="91px" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="Button2" runat="server" BackColor="#FF3300" BorderStyle="Ridge" 
